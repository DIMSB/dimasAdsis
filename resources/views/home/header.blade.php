                     ...
                     <ul class="navbar-nav">
                       ...
                       <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li><a href="{{url('All_products',urlencode($catagories->catagory_name))}}">{{$catagories->catagory_name}}</a></li>
                              @endforeach
                           </ul>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                           <a class="btn btn-primary" style="margin-top:5px" id="logincss" href="{{ route('login') }}">Login</a>
                        </li>
                        <li class="nav-item">
                           <a class="btn btn-success" style="margin-top:5px" href="{{ route('register') }}">Register</a>
                        </li>
                        @endauth
